...
public class CommunityController {
    ...
    @PostMapping("/join-plogging")
    public SingleResult<JoinMember> joinPlogging(HttpServletRequest request, @RequestParam("postId")Long postId){
        log.info("[플로깅 참가]");
        return responseService.getSingleResult(communityService.joinPlogging(request,postId));
    }
}
